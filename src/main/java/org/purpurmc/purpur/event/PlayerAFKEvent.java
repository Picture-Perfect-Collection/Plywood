...
public class PlayerAFKEvent extends PlayerEvent implements Cancellable {
    ...
    public boolean isGoingAfk() { return setAfk; }
    public boolean shouldKick() { return shouldKick; }
    public void setShouldKick(boolean shouldKick) { this.shouldKick = shouldKick; }
    @Nullable public String getBroadcastMsg() { return broadcast; }
    public void setBroadcastMsg(@Nullable String broadcast) { this.broadcast = broadcast; }
